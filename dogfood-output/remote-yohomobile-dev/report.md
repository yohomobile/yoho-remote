# Dogfood Report: Yoho Remote

| Field | Value |
|-------|-------|
| **Date** | 2026-04-14 |
| **App URL** | https://remote.yohomobile.dev |
| **Session** | remote-yohomobile-dev |
| **Scope** | 线上已部署 Web 应用核心流程排查 |
...
1. Navigate to https://remote.yohomobile.dev
