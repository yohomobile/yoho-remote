...
// StoredPersonIdentityCandidate moved to the unified Approvals Engine —
// see server/src/approvals/domains/identity.ts (IdentityApprovalPayload).
...
// Phase 3B/3C/3F candidate types (TeamMemory / MemoryConflict / Observation)
// were merged into the unified Approvals Engine — see
// server/src/approvals/types.ts and server/src/approvals/domains/*.ts.
