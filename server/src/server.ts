...
export async function startWebServer(options: {
    ...
    const wsIdleTimeout = Math.max(60, socketHandler.idleTimeout)
    console.log(`[Web] WebSocket idleTimeout: ${wsIdleTimeout}s (socketHandler.idleTimeout: ${socketHandler.idleTimeout})`)
