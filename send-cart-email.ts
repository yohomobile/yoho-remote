...
<head>
    ...
    <style>
        @media only screen and (max-width: 600px) {
            ...
            .two-buttons { flex-direction: column !important; gap: 12px !important; }
            .button-secondary { margin-left: 0 !important; margin-top: 12px !important; }
        }
    </style>
</head>
                    ...
                    <tr>
                        <td class="content" style="padding: 48px 40px;">
                            ...
                            <div style="text-align: center; margin: 40px 0;">
                                <a href="#" class="button" style="display: inline-block; background: linear-gradient(135deg, #FF8C42 0%, #FF6B35 100%); color: #ffffff; text-decoration: none; padding: 18px 48px; border-radius: 50px; font-weight: 600; font-size: 17px; box-shadow: 0 8px 24px rgba(255, 107, 53, 0.35); transition: all 0.3s ease;">
                                    Resume Checkout →
                                </a>
                            </div>
                            ...
                            <div style="background-color: #f8f9fa; border-radius: 12px; padding: 28px; margin: 32px 0;">
                                ...
                                <a href="#" class="button-secondary" style="display: inline-block; background-color: #ffffff; color: #FF6B35; text-decoration: none; padding: 14px 32px; border-radius: 50px; font-weight: 600; font-size: 15px; border: 2px solid #FF6B35;">
